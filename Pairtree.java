...
/**
 * This class was written by Justin Littman at the LoC and included in the bagit
 * library. I didn't need most functions of that library, but I did need a pairtree
 * translator, so I've incorporated this code directly instead of referencing
 * the whole library.
 * 
 * DESCRIPTION: The PAIRTREE LIBRARY is a software library that supports the mapping between
 * identifiers and filepaths according to the Pairtree Specification 
 * (https://confluence.ucop.edu/display/Curation/PairTree).
 * 
 * @author Justin Littman (jlit@loc.gov)
 * @version 1.1.1
 * @since 2013-12-21
 *
 */
